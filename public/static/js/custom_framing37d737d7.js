                                                    ...
                                                    case 36:
                                                        return (
                                                            ...
                                                            _()({
                                                                type: "error",
                                                                title: "Uh oh!",
                                                                html: 'An error occured while trying to add your product to cart.<br/>Please refresh the page and try again, or <a href="/contact-us">contact us.</a>',
                ...
                i = [
                    function () {
                        var t = this,
                            e = t.$createElement,
                            a = t._self._c || e;
                        return a("thead", [a("tr", [a("td"), t._v(" "), a("td", [t._v("Product Summary")]), t._v(" "), a("td", [t._v("Price Breakdown")])])]);
                    },
                ],
                r = { render: n, staticRenderFns: i };
            e.a = r;
                                                    ...
                                                    [
                                                        a("div", { staticClass: "column field is-grouped is-horizontal", staticStyle: { padding: "0", "flex-direction": "column" }, attrs: { slot: "top" }, slot: "top" }, [
                                                            a("div", { staticStyle: { display: "flex", "align-items": "baseline" } }, [
                                                                a("label", { staticStyle: { "padding-right": "2px" }, attrs: { id: "quantity-label", for: "bulk_option" } }, [t._v("Bulk Buy:")]),
                                                                t._v(" "),
                                                                a("div", { staticClass: "select", staticStyle: { "margin-left": "5px" } }, [
                                                                    a(
                                                                        "select",
                                                                        {
                                                                            directives: [{ name: "model", rawName: "v-model", value: t.pack_size, expression: "pack_size" }],
                                                                            attrs: { name: "bulk_option", id: "bulk_option", title: "Bulk Options" },
                                                                            on: {
                                                                                change: function (e) {
                                                                                    var a = Array.prototype.filter
                                                                                        .call(e.target.options, function (t) {
                                                                                    ...
                                                                                    t.pack_size = e.target.multiple ? a : a[0];
                                                                                },
                                                                            },
                                                                        },
                                                                        t._l(t.bulk_options, function (e) {
                                                                            return a("option", { domProps: { value: e.quantity } }, [t._v("\n                        " + t._s(e.label) + "\n                      ")]);
                                                                        }),
                                                                        0
                                                                    ),
                                                                ]),
                                                                ...
                                                                a(
                                                                    ...
                                                                    [
                                                                        ...
                                                                        a("p", { attrs: { slot: "errors" }, slot: "errors" }, [
                                                                            ...
                                                                            a("a", { attrs: { href: "/contact-us", title: "Contact us" } }, [t._v("contact us")]),
                                                                        ]),
                                                                    ],
                                                                    2
                                                                ),
